    ...
    <header className="w-full py-6 lg:py-4 relative border-b">
      ...
      <div className="container mx-auto px-8 lg:px-4 flex items-center justify-between">
        ...
        <div className="relative">
          ...
          {logOutDropdown && (
            <div ref={dropdownRef} className='absolute right-0 top-12 py-1 px-2 w-48 rounded-sm bg-white border shadow'>
              <button onClick={handleLogOut} className="w-full px-2 py-2 rounded-md text-right hover:bg-gray-200 duration-200">Log Out</button>
            </div>
          )}
        </div>
      </div>
